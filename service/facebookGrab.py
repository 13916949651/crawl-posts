...
class FacebookGrab(object):
    ...
    def __init__(self, user_name, path_name=None):
        ...
        # 保存所有的图片和视频地址
        self.video_url_list = []
        for post in get_posts(user_name, pages=50, credentials={'luotaibin@gmail.com', 'ltb518818lfan'}):
            if post['video'] is not None:
                self.video_url_list.append(post['video'])
        self.download_img()

    def download_img(self):
        dirpath = '/Users/heavengifts/Desktop/facebook/{}'.format(self.path_name)
        ...
        for i in range(len(self.video_url_list)):
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    # 判断后缀
                    file_path = r'/Users/heavengifts/Desktop/facebook/{path}/{name}.{mp4}'.format(path=self.path_name,
...
if __name__ == '__main__':
    ...
    ins_spider = FacebookGrab(user_name='vapempireklangparade')
